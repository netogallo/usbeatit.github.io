/* $Id: img_assist.js,v 1.4.2.5.2.2 2009/01/18 03:54:53 sun Exp $ */

// D5 only.
Drupal.behaviors = Drupal.behaviors || {};
Drupal.theme = Drupal.theme || function(func) {
...
Drupal.theme.prototype.img_assist_link = function(el) {
  var html = '<div class="img_assist-button">', link = Drupal.settings.img_assist.link_text;
  ...
  html += '<a href="'+ Drupal.settings.basePath +'index.php?q=img_assist/load/textarea&textarea='+ el.name +'" class="img_assist-link" id="img_assist-link-'+ el.id +'" title="'+ Drupal.settings.img_assist.link_text +'" onclick="window.open(this.href, \'img_assist_link\', \'width=600,height=350,scrollbars=yes,status=yes,resizable=yes,toolbar=no,menubar=no\'); return false;">'+ link +'</a>';
  html += '</div>';
  return html;
}
 ...
 */
$(function() {
  Drupal.behaviors.img_assist(document);
});
